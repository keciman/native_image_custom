...
public class NativeScreenshotPlugin implements MethodCallHandler, FlutterPlugin, ActivityAware {
	...
	public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
		...
		if(path==null)
		{
			...
			takeScreenshotOld(quality,path);
	...
	private String writeBitmap(Bitmap bitmap,int quality,String pathToScreenshot) {
		try {
			String path = pathToScreenshot;
	...
	private void takeScreenshotOld(int quality,String pathToScreenshot) {
		...
		try {
			...
			String path = writeBitmap(bitmap,quality,pathToScreenshot);
